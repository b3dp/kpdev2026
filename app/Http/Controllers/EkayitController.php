    ...
    public function store(Request $request)
    {
        try {
            ...
            $veri = $request->validate([
                ...
                'ogrenci_adres' => ['required', 'string', 'max:1000'],
                'ogrenci_ikamet_il' => ['required', 'string', 'max:100'],
                'ogrenci_ikamet_ilce' => ['required', 'string', 'max:100'],
                ...
                'veli_telefon_sahibi_2' => ['required', 'string', 'in:anne,baba,yakini'],
                'veli_telefon_2' => ['required', 'string', 'regex:/^0?5\d{9}$/', 'different:veli_telefon'],

                'veli_eposta' => ['required', 'email', 'max:255'],
                'veli_il' => ['required', 'string', 'max:100'],
                'veli_ilce' => ['required', 'string', 'max:100'],
                'veli_adres' => ['required', 'string', 'max:1000'],
                ...
                'ogrenci_adres.required' => 'Öğrenci adres alanı zorunludur.',
                'ogrenci_ikamet_il.required' => 'Öğrenci ikamet ili zorunludur.',
                'ogrenci_ikamet_ilce.required' => 'Öğrenci ikamet ilçesi zorunludur.',
                'ogrenci_telefon.regex' => 'Telefon numarasını 5321234567 formatında giriniz.',
                'veli_telefon_sahibi_1.required' => 'Veli telefon seçimi 1 alanı zorunludur.',
                'veli_telefon.regex' => 'Telefon 1 numarasını 5321234567 formatında giriniz.',
                'veli_telefon_sahibi_2.required' => 'Telefon 2 için kime ait olduğunu seçiniz.',
                'veli_telefon_2.required' => 'Telefon 2 alanı zorunludur.',
                'veli_telefon_2.regex' => 'Telefon 2 numarasını 5321234567 formatında giriniz.',
                'veli_telefon_2.different' => 'Veli telefon numaralarının ikisi aynı olamaz.',
                'veli_il.required' => 'Veli ili zorunludur.',
                'veli_ilce.required' => 'Veli ilçesi zorunludur.',
                'veli_adres.required' => 'Veli açık adresi zorunludur.',
