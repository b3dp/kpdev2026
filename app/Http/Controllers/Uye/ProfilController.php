...
class ProfilController extends Controller
{
    ...
    public function guncelle(Request $request)
    {
        ...
        $veri = $request->validate([
            ...
            'nsosyal' => ['nullable', 'string', 'max:255'],
        ...
        $mezunVerisi = [
            ...
            'nsosyal' => filled($veri['nsosyal'] ?? null) ? trim((string) $veri['nsosyal']) : null,
            'facebook' => filled($veri['facebook'] ?? null) ? trim((string) $veri['facebook']) : null,
            'youtube' => filled($veri['youtube'] ?? null) ? trim((string) $veri['youtube']) : null,
