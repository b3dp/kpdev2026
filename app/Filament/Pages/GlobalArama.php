...
class GlobalArama extends Page
{
    ...
    public function ara(): void
    {
        ...
        // Kişiler — Scout (telefon, ad, soyad, eposta, meslek)
        try {
            ...
            Log::error('GlobalArama kisi: '.$e->getMessage());
            $this->sonuclar['kisiler'] = [];
        }

        // Üyeler — DB LIKE (ad_soyad, telefon, eposta)
        try {
            ...
            Log::error('GlobalArama uye: '.$e->getMessage());
        ...
        try {
            ...
            Log::error('GlobalArama haber: '.$e->getMessage());
        ...
        try {
            ...
            Log::error('GlobalArama ekayit: '.$e->getMessage());
            $this->sonuclar['ekayit_kayitlar'] = [];
        }

        // Bağışlar — DB join (bagis_no, üye adı/telefon, kişi adı/telefon)
        try {
            ...
            Log::error('GlobalArama bagis: '.$e->getMessage());
            $this->sonuclar['bagislar'] = [];
        }

        // Mezunlar — DB join (üye adı/telefon, meslek, il)
        try {
            ...
            Log::error('GlobalArama mezun: '.$e->getMessage());
        ...
        try {
            ...
            Log::error('GlobalArama etkinlik: '.$e->getMessage());
        ...
        try {
            ...
            Log::error('GlobalArama kurum: '.$e->getMessage());
        ...
        try {
            ...
            Log::error('GlobalArama kurumsalsayfa: '.$e->getMessage());
