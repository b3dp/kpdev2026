...
return [
    ...
    'geo_position' => env('SITE_GEO_POSITION', '38.3945641;27.0990445'),
    'geo_icbm' => env('SITE_GEO_ICBM', '38.3945641, 27.0990445'),
    'schema_locality' => env('SITE_SCHEMA_LOCALITY', 'Karabağlar'),
    'schema_region' => env('SITE_SCHEMA_REGION', 'İzmir'),
